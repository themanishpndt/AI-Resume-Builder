...
if os.getenv('POSTGRES_DB') or os.getenv('DB_NAME'):
    ...
    # Be defensive: if DATABASE_URL is empty or malformed, catch the parse error
    ...
    if db_url:
        try:
            ...
            # In production (Render) you should correct the DATABASE_URL setting instead of relying on sqlite.
